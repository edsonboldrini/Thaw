...
private struct MenuBarSearchContentView: View {
    ...
    var body: some View {
        mainContent
            ...
            .glassEffectCompat(in: RoundedRectangle(cornerRadius: ThawRadius.card, style: .continuous))
    ...
    var body: some View {
        Button(action: action) {
            HStack(spacing: 5) {
                ...
                .padding(.vertical, 2)
                .glassEffectCompat(in: RoundedRectangle(cornerRadius: 5, style: .continuous))
                .foregroundStyle(.secondary)
